...
while count<2:
	...
	if main_opt=="1":
		...
		notice=""
		print(cyan+"\n\n\tYoutube:"+yellow+"\n\n\t YT gaming FFH"+cyan+"\n\n\tFacebook:"+yellow+"\n\n\t moynul "+cyan+"\n\n\tWhat\'s app:"+yellow+"\n\n\t Fuck office "+cyan+"\n\n\tTelegram:\n"+yellow+"No"+cyan+"\n\n\n\n\tContact Us:"+yellow+"\n\n\lovehaker64@gmail.com"+cyan+"\n\n\n\tDeveloped By "+yellow+"Moynul hassan"+cyan+"\n\tFB:"+yellow+" https://www.facebook.com/profile.php?id=100028650051426")
